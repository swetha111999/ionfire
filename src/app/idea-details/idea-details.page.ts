...
export class IdeaDetailsPage implements OnInit {
  ...
  addIdea() {
    this.ideaService.addIdea(this.idea).then(() => {
      ...
      this.showToast('There was a problem adding your Review :(');
    });
  }
  ...
  deleteIdea() {
    this.ideaService.deleteIdea(this.idea.id).then(() => {
      ...
      this.showToast('There was a problem deleting your Review :(');
    });
  }
  ...
  updateIdea() {
    this.ideaService.updateIdea(this.idea).then(() => {
      ...
      this.showToast('There was a problem updating your Review :(');
    });
  }
